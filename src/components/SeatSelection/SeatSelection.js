...
export default function SeatSelection() {
    ...
    const handleSubmitDetails = e => {
        e.preventDefault()
        setArrowDown(true)
        if (seatNumber.length === name.length) {
        ...
        return seatArray.map((seat, idx) => {
            return (
                <form key={idx} className="form seatfrm">
                    ...
                    <input className="form-control seatInp" onBlur={e => handlePassengerName(e)} type="text" name="passenger-name" placeholder="Enter Name" autoComplete="off" />
